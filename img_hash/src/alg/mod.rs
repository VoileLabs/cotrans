...
impl HashAlg {
    ...
    B: BitSet,
  {
    ...
    match (*self, hash_vals) {
      ...
      (VertGradient, Floats(ref floats)) => B::from_bools(vert_gradient_hash(floats, rowstride)),
      ...
      (DoubleGradient, Bytes(ref bytes)) => B::from_bools(double_gradient_hash(bytes, rowstride)),
